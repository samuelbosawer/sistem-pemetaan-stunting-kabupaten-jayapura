            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 ">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title"> Data Distrik</h4>
                                <div class="row mt-3 d-flex justify-content-between">
                                    ...
                                    <div class="">
                                        <a class="btn btn-dark" href="{{ route('admin.distrik.tambah') }}"> Tambah Data <i
                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{route('admin.distrik.csv')}}" method="post" enctype="multipart/form-data">
                                                        @csrf
